...
window.addEventListener('load', () => {
    ...
    // Add letter-by-letter animation to name
    ...
    if (nameElement) {
        ...
        nameText.split('').forEach((letter, index) => {
            ...
            span.addEventListener('mouseenter', () => {
                span.style.transform = 'translateY(-8px) scale(1.2) rotateZ(-10deg)';
                span.style.textShadow = '0 0 25px rgba(0, 255, 136, 1)';
                span.style.color = '#00ff88';
            });
            
            span.addEventListener('mouseleave', () => {
                span.style.transform = 'translateY(0) scale(1) rotateZ(0deg)';
                span.style.textShadow = '0 0 10px rgba(0, 255, 136, 0.5)';
                span.style.color = '';
            });
        ...
        setInterval(() => {
            ...
            spans.forEach((span, index) => {
                if (Math.random() < 0.1) { // 10% chance each frame
                    span.style.transform = `translateY(-2px) scale(1.05) rotateZ(${(Math.random() - 0.5) * 5}deg)`;
                    setTimeout(() => {
                        span.style.transform = 'translateY(0) scale(1) rotateZ(0deg)';
                    }, 200);
                }
